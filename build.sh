...
cmd_config="${ASAN_FLAGS}cmake -G \"$BUILD_GENERATOR\" -DBUILD_SSE2_CODEPATHS=OFF -DCMAKE_INSTALL_PREFIX=${INSTALL_PREFIX} -DCMAKE_BUILD_TYPE=${BUILD_TYPE} ${CMAKE_MORE_OPTIONS} -DLENSFUN_INCLUDE_DIR=/opt/include/lensfun -DUSE_OPENEXR=OFF \"$DT_SRC_DIR\""
